...
## add 2021-12-12
from https://github.com/swz30/MPRNet
And fixed the upsampling warning.
"""
...
class DownSample(nn.Module):
    def __init__(self, in_channels, s_factor):
        ...
        self.down = nn.Conv2d(in_channels, in_channels + s_factor, 1, stride=1, padding=0, bias=False)
...
class UpSample(nn.Module):
    def __init__(self, in_channels, s_factor):
        ...
        self.up = nn.Conv2d(in_channels + s_factor, in_channels, 1, stride=1, padding=0, bias=False)
